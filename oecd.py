...
oecd_url='https://sdmx.oecd.org/public/rest/data/OECD.DCD.FSD,DSD_DAC1@DF_DAC1,/DAC.1010..1140+1160..Q.?startPeriod=1990&endPeriod=2017&dimensionAtObservation=AllDimensions'
...
oecd_url='https://sdmx.oecd.org/public/rest/data/OECD.DCD.FSD,DSD_DAC1@DF_DAC1,/DAC.11010..1140+1160..Q.?startPeriod=2018&dimensionAtObservation=AllDimensions'
result = requests.get(oecd_url, headers={'Accept': 'text/csv'})
